...
class TopViewsResponseTest(unittest.TestCase):
	def test_init_response(self):
		...
		result = response.TopViewsResponse([day1, day2], datetime(2023, 7, 1), datetime(2023, 7, 7))
	...
	def test_exception(self):
		...
		self.assertRaises(ParseResponseException, lambda: TopViewsResponse([day1, day2], datetime(2023, 7, 1), datetime(2023, 7, 7)))
...
class DateWithMostViewsResponseTest(unittest.TestCase):
	...
	def test_exception(self):
		...
		self.assertRaises(ParseResponseException, lambda: DateWithMostViewsResponse([day1, day2], "foo"))
...
class ArticleViewsResponseTest(unittest.TestCase):
	...
	def test_exception(self):
		...
		self.assertRaises(ParseResponseException, lambda: ArticleViewsResponse(data, "foo", "2023/07/01", "2023/07/07"))
